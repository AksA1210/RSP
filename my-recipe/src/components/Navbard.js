...
import { useHistory } from 'react-router-dom'; // Changed the import
import axios from 'axios';
import { Link } from 'react-router-dom';
//import { ReactComponent as Logo } from "../images/Free_Sample_By_Wix.jpg";
...
const Navbard = () => {
  ...
  const [searchHistory, setSearchHistory] = useState([
    "Groceries", "Mobiles", "Furniture", "Lights", "Laptops"
  ]);
